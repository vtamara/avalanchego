...
func (m *MockState) GetMerkleRoot() ids.ID {
	m.ctrl.T.Helper()
...
func (mr *MockStateMockRecorder) GetMerkleRoot() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMerkleRoot", reflect.TypeOf((*MockState)(nil).GetMerkleRoot))
}
